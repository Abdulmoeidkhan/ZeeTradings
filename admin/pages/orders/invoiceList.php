                ...
                <main class="container-fluid">
                    <div class="container-fluid px-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="mt-4">Invoice List</h2>
                            <a class="btn btn-primary" href="./addinvoice.php" role="button">+ Add Invoice</a>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        WHERE o.deleted=0 and o.orderType=1;";
                                        require("../../../functions/conn.php");
                                        $data = $connection->query($invoiceFetch);
                                        if ($data) {
        ...
        <script>
            function deleteFunc(id) {
                ...
                if (valToBeCheck === 'delete') {
                    window.loinvoiceion.href = '../../../functions/deleteinvoice.php?invoiceId=' + id;
                }
            }
        </script>
